...
<head>
    ...
    <link href="<?php echo URLROOT; ?>/lib/rickshaw/rickshaw.min.css" rel="stylesheet">
    <link href="<?php echo URLROOT; ?>/lib/select2/css/select2.min.css" rel="stylesheet">
...
<script src="<?php echo URLROOT; ?>/lib/perfect-scrollbar/perfect-scrollbar.min.js"></script>
<script src="<?php echo URLROOT; ?>/lib/moment/min/moment.min.js"></script>
<script src="<?php echo URLROOT; ?>/lib/peity/jquery.peity.min.js"></script>
<script src="<?php echo URLROOT; ?>/lib/rickshaw/vendor/d3.min.js"></script>
<script src="<?php echo URLROOT; ?>/lib/rickshaw/vendor/d3.layout.min.js"></script>
<script src="<?php echo URLROOT; ?>/lib/rickshaw/rickshaw.min.js"></script>
<script src="<?php echo URLROOT; ?>/lib/jquery.flot/jquery.flot.js"></script>
<script src="<?php echo URLROOT; ?>/lib/jquery.flot/jquery.flot.resize.js"></script>
<script src="<?php echo URLROOT; ?>/lib/flot-spline/js/jquery.flot.spline.min.js"></script>
<script src="<?php echo URLROOT; ?>/lib/jquery-sparkline/jquery.sparkline.min.js"></script>
<script src="<?php echo URLROOT; ?>/lib/echarts/echarts.min.js"></script>
<script src="<?php echo URLROOT; ?>/lib/select2/js/select2.full.min.js"></script>
<script src="http://maps.google.com/maps/api/js?key=AIzaSyAq8o5-8Y5pudbJMJtDFzb8aHiWJufa5fg"></script>
<script src="<?php echo URLROOT; ?>/lib/gmaps/gmaps.min.js"></script>
<script src="<?php echo URLROOT; ?>/js/bracket.js"></script>
<script src="<?php echo URLROOT; ?>/js/map.shiftworker.js"></script>
<script src="<?php echo URLROOT; ?>/js/ResizeSensor.js"></script>
