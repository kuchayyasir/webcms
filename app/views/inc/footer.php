...
<script src="<?php echo URLROOT; ?>/js/vendor/jquery-2.2.4.min.js"></script>
...
<script src="<?php echo URLROOT; ?>/js/easing.min.js"></script>
<script src="<?php echo URLROOT; ?>/js/hoverIntent.js"></script>
<script src="<?php echo URLROOT; ?>/js/superfish.min.js"></script>
...
<script src="<?php echo URLROOT; ?>/js/hexagons.min.js"></script>
<script src="<?php echo URLROOT; ?>/js/jquery.nice-select.min.js"></script>
